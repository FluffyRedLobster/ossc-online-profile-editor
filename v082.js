ossc_data = function () {
        ...
        { 
            ...
            settings: [
                { 
                    ...
                    step: 1,
                    default_value: DEFAULT_SAMPLER_PHASE,
                    value_displ_func: "sampler_phase_disp",
                },
                { 
                    id: "s480p_mode",
    ...
    const video_modes_def = [
        ...
        [ "512x240LB",   512,  240,   682,  312,   77, 41,   50, 3,  (VIDEO_SDTV | VIDEO_PC),   GROUP_240P,     (MODE_L3_512_COL | MODE_L4_512_COL | MODE_L5_512_COL) ],
